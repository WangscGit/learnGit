 ...
 */
@Controller
@RequestMapping(value="/flowPng2")
public class DiagramPngController2 {
	    @Autowired
	    ...
	    public static void main(String[] args){
	    	DiagramPngController2 e = new DiagramPngController2();
	    	try {
				e.test(null);
			} catch (Exception e1) {
				e1.printStackTrace();
...
//	        repositoryService.createDeployment().addClasspathResource("com/pzr/demo/diagrams/MyProcess.bpmn").deploy();
	        // 开启流程，myprocess是流程的ID
	    		    	...
	    		    	ProcessInstance instance = processEngine.getRuntimeService().startProcessInstanceByKey("test7");
	        // 查询历史表中的Task
