...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge,Chrome=1">
     ...
     <link rel="stylesheet" href="<%=path %>/css/cms-design-process-StandardizeFigure.css"/>
    ...
    <div class="bd">
        ...
        <ul>
            <li>明细表</li>           
              ...
              <div class="bottom">
                     <p><img src="images/design2.png">&nbsp;装配图</p>
                     <div>
                     <a><span class="glyphicon glyphicon-list-alt"></span>&nbsp;查看装配图;</a>  
                     </div>                  
              </div>   
              <div class="bottom">
                     <p><img src="images/design2.png">&nbsp;机加工图</p>
                     <div>
                     <a><span class="glyphicon glyphicon-list-alt"></span>&nbsp;查看机加工图;</a>  
                     </div>                  
              </div> 
              <div class="bottom">
                     <p><img src="images/design7.png">&nbsp;加工数据</p>
                     <table class="table table-bordered table-hover bottomTable">
                      <thead>
                        <tr>
                                <td>序号</td>
                                <td>名称</td>
