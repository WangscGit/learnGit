...
function SelectBox(b, c, d, e) {
	...
	b.html('<input type="text" name="selectBoxShow" value="' + r + '" placeholder="' + q + '"/>				<div class="overlay"></div>				<i><em></em></i>				<ul>				</ul>');
